...
is $n16.b, 0x1234;
is $n16.c, 99;
is $n16.unpacked-size, nativesizeof($n16);
...
is $n32.b, 0x12345678;
is $n32.c, 99;
is $n32.unpacked-size, nativesizeof($n32);
...
is $n64.c, 99;
is $n64.unpacked-size, nativesizeof($n64);
...
is $n32-num.c, 99;
is $n32-num.unpacked-size, nativesizeof($n32-num);
...
is $n64-num.c, 99;
is $n64-num.unpacked-size, nativesizeof($n64-num);
...
is $n-size_t.c, 99;
is $n-size_t.unpacked-size, nativesizeof($n-size_t);
...
is $n-long.c, 99;
is $n-long.unpacked-size, nativesizeof($n-long);
...
is $n-longlong.c, 99;
is $n-longlong.unpacked-size, nativesizeof($n-longlong);
